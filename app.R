     ...
     dashboardBody(
          tabItems(
               ...
               tabItem(tabName = "retrasadas",
                       ...
                       fluidRow(
                            box(title = "Top 10 Responsables con más Retrasadas", status = "info", width = 6,
               ...
               tabItem(tabName = "exceptuadas",
                       ...
                       fluidRow(
                            box(title = "Top 10 Responsables con más Exceptuadas Transitorias", status = "info", width = 6,
                                plotlyOutput("top_responsables_exceptuadas", height = "450px")),
                            box(title = "Top 10 Problemas de Salud con más Exceptuados Transitorias", status = "info", width = 6,
